...
% Create Bounds
LB= [1 1];  %Lower Bound
UB= [50 15];  %Upper Bound

% Optimization Options
optimization = optimoptions(@ga, 'MaxGenerations', 500, 'PopulationSize', 500 ...
    , 'FunctionTolerance', 1e-10, 'EliteCount', 10, 'PlotFcn', {@gaplotbestf,@gaplotstopping});

% Run GA
rng(0, 'twister');

[xbest, fbest, exitflag] = ga(@Volume, 2, [], [], [], [], ...
    LB, UB, @cantileverConstraints, [1 2], optimization);
